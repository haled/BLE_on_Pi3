...
var MyEddystoneBeaconScanner = function() {
  this._discovered = {};

  noble.on('discover', this.onDiscover.bind(this));
};

util.inherits(MyEddystoneBeaconScanner, events.EventEmitter);

MyEddystoneBeaconScanner.prototype.startScanning = function(allowDuplicates) {
  //debug('startScanning');
...
MyEddystoneBeaconScanner.prototype.stopScanning = function() {
...
MyEddystoneBeaconScanner.prototype.onDiscover = function(peripheral) {
...
MyEddystoneBeaconScanner.prototype.checkLost = function() {
...
MyEddystoneBeaconScanner.prototype.isBeacon = function(peripheral) {
...
MyEddystoneBeaconScanner.prototype.parseBeacon = function(peripheral) {
...
MyEddystoneBeaconScanner.prototype.parseUidData = function(data) {
  return {
...
MyEddystoneBeaconScanner.prototype.parseUrlData = function(data) {
  return {
    txPower: data.readInt8(1),
...
MyEddystoneBeaconScanner.prototype.parseTlmData = function(data) {
  return {
    tlm: {
...
MyEddystoneBeaconScanner.prototype.calculateDistance = function(txPower, rssi) {
  return Math.pow(10, ((txPower - rssi) - 41) / 20.0);
};

module.exports = MyEddystoneBeaconScanner;
